...
import { ShoppingCart, Menu, Phone, MapPin, User, LogOut, Globe, Search, Heart, Package, Percent, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center justify-between gap-4 h-16 lg:h-20">
          ...
          <Link to={createPageUrl('Home')} className="flex items-center gap-2 sm:gap-3 group flex-shrink-0">
            ...
            <div className="hidden sm:block">
              <h1 className="font-black text-base sm:text-xl bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 bg-clip-text text-transparent leading-tight">Dang Bazaar</h1>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[350px]">
                <div className="flex flex-col h-full">
                  ...
                  <div className="py-4 border-b">
                    <h2 className="font-bold text-xl bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Dang Bazaar</h2>
